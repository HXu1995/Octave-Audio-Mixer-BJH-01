 ...
 * File: _coder_doFilterf060_api.c
 *
 ...
 * Return Type  : void
 */
void doFilterf060_api(const mxArray * const prhs[1], const mxArray *plhs[1])
{
  real32_T (*y)[512];
  real32_T (*x)[512];
 ...
 * Return Type  : void
 */
void doFilterf060_atexit(void)
{
  mexFunctionCreateRootTLS();
  emlrtEnterRtStackR2012b(emlrtRootTLSGlobal);
  emlrtLeaveRtStackR2012b(emlrtRootTLSGlobal);
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
  doFilterf060_xil_terminate();
}
 ...
 * Return Type  : void
 */
void doFilterf060_terminate(void)
{
  emlrtLeaveRtStackR2012b(emlrtRootTLSGlobal);
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
}
...
/*
 * File trailer for _coder_doFilterf060_api.c
 *
 * [EOF]
 */
