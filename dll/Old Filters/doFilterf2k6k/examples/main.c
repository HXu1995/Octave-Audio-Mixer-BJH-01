...
static void main_doFilterf2k6k(void)
{
  ...
  /* Initialize function 'doFilterf2k6k' input arguments. */
  /* Initialize function input argument 'x'. */
  /* Call the entry-point 'doFilterf2k6k'. */
