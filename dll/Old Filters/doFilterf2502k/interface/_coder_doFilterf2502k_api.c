 ...
 * File: _coder_doFilterf2502k_api.c
 *
 ...
 * Return Type  : void
 */
void doFilterf2502k_api(const mxArray * const prhs[1], const mxArray *plhs[1])
{
  real_T x;
 ...
 * Return Type  : void
 */
void doFilterf2502k_atexit(void)
{
  mexFunctionCreateRootTLS();
  emlrtEnterRtStackR2012b(emlrtRootTLSGlobal);
  emlrtLeaveRtStackR2012b(emlrtRootTLSGlobal);
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
  doFilterf2502k_xil_terminate();
}
 ...
 * Return Type  : void
 */
void doFilterf2502k_terminate(void)
{
  emlrtLeaveRtStackR2012b(emlrtRootTLSGlobal);
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
}
...
/*
 * File trailer for _coder_doFilterf2502k_api.c
 *
 * [EOF]
 */
